...
public class GenerateDeclsFile {
    ...
    private static String openApiSpecPath = "oas-instrumenter-main/src/test/resources/evaluationOracles/Spotify/createPlaylist/swagger_createPlaylist.yaml";
    private static String testCasesFilePath = "oas-instrumenter-main/src/test/resources/evaluationOracles/Spotify/createPlaylist/50/Spotify_CreatePlaylist_50.csv";
